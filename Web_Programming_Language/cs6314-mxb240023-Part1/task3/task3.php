...
<!-- Header -->
<header class="utd-header text-center py-3">
    <img src="images/utd-logo.png" alt="UT Dallas Logo" height="140">
    <h2 class="mt-2">Course Management System</h2>
</header>
...
<main class="container my-4">
    ...
    <div id="coursesAccordion" class="mt-3">
        ...
        ?>
        <div class="card mb-1">
            <div class="card-header bg-utd-orange">
            ...
            <div id="course<?= preg_replace('/[^a-zA-Z0-9]/', '', $row['course_number']) ?>" class="collapse">
                <div class="card-body">
                    ...
                    <!-- Delete Button -->
                    <form action="task3_deletecourse.php" method="POST" style="display:inline;">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="addCourseForm" method="POST" action="task3_addcourse.php">
...
<div class="modal fade" id="updateCourseModal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="updateCourseForm" method="POST" action="task3_updatecourse.php">
...
<script>
    ...
    $('#courseSearch').on('input', function() {
        ...
        $('#coursesAccordion .card').filter(function() {
            $(this).toggle($(this).text().toLowerCase().indexOf(value) > -1)
        });
    });

    // Pre-fill update modal
